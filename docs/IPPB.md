...
9. **Packaging** — npm brand and/or transitional published **or** explicit external blocker + git install path
10. **Clean** — no archived family package deps; no misleading family SSOT docs
11. **Brand** — Locus documented; expand–contract dual ids when brand ≠ transitional
